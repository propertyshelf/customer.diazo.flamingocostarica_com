# -*- coding: utf-8 -*-
"""Test Setup of customer.diazo.flamingocostarica_com."""
...
# local imports
from customer.diazo.flamingocostarica_com import (
    config,
    testing,
)
...
CSS = [
    '++resource++customer.diazo.flamingocostarica_com/main.css',
]

JS = [
    '++resource++customer.diazo.flamingocostarica_com/main.js',
]


class TestSetup(unittest.TestCase):
    """Validate setup process for customer.diazo.flamingocostarica_com."""

    layer = testing.CUSTOMER_DIAZO_FLAMINGOCOSTARICA_COM_INTEGRATION_TESTING
    ...
    def test_addon_layer(self):
        ...
        self.assertIn('ICustomerDiazoFlamingocostaricaComLayer', layers)
...
class UninstallTestCase(unittest.TestCase):
    ...
    def test_addon_layer_removed(self):
        ...
        layers = [l.getName() for l in registered_layers()]
        self.assertNotIn('ICustomerDiazoFlamingocostaricaComLayer', layers)
